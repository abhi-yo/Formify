        ...
        <TabsContent value="integration" className="mt-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium mb-2">1. Add the Formify Script</h3>
                <div className="bg-gray-100 p-4 rounded text-sm font-mono">
                  {`<script src="${
                    process.env.NEXT_PUBLIC_APP_URL || "https://formify.app"
                  }/api/script?key=${project.publicKey}&debug=true"></script>`}
                </div>
              </div>
  ...
  <button type="submit">Send</button>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-sm text-blue-800 space-y-1">
                <p>
                  <strong>Endpoint:</strong> POST /api/submit
                </p>
                <p>
                  <strong>Public Key:</strong> {project.publicKey}
                </p>
                <p>
                  <strong>Secret Key:</strong>{" "}
                  {project.secretKey.substring(0, 8)}... (Keep this private!)
                </p>
              </div>
            </div>
          </div>
